...
> Answer: Client side routing allows applications to run faster by initially downloading everything and from then on you are only downloading what you need to to load that one page or route.
- [ ] What does AJAX stand for?
> Answer: Asynchronous JavaScript and XML
- [ ] What are `controlled components` in React?
> Answer: A controlled component is where you control and give assignment to the value of an input field.  You use the input data and when you output data, it is output by the assigned React state.
